...
const COMMANDS: Omit<AppCommand, 'enabled'>[] = [
  { id: 'openSceneGenerator', label: '1. 장면 만들기', description: '자연어로 인물·소품·카메라를 구성해 첫 장면을 만듭니다.', category: 'workflow', keywords: ['자연어', 'scene', '장면', '초안'], shortcut: 'G' },
  ...
  { id: 'exportShotPackage', label: '3. AI용 내보내기', description: '이미지·영상 생성 AI용 프레임, 제어 이미지와 프롬프트를 만듭니다.', category: 'workflow', keywords: ['export', '출력', '패키지'], shortcut: 'Alt+6' },
  ...
  { id: 'togglePlayback', label: '동작 미리보기·정지', description: '생성 전에 현재 샷의 움직임과 카메라 동선을 검수합니다.', category: 'timeline', keywords: ['play', '재생', '정지'], shortcut: 'Space' },
